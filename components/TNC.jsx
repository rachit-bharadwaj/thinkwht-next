  ...
  return (
    <div
      ...
      className="absolute top-16 bg-white text-black z-50 max-h-[80vh] overflow-y-scroll 
                    p-10 md:mx-24 lg:mx-56 rounded-lg border scrollbar scrollbar-none"
    >
      <div className="termspopup">
        <div className="flex lg:space-x-[65%] mb-[10px] popupnav space-x-[35%] lg:px-5 lg:py-7">
        ...
        <hr className="border mx-3 border-black" />
        <div className="terms-content lg:mt-7">
          <h1>1. INTRODUCTION</h1>
          <p>
            Welcome to Thinkwht (“Company”, “we”, “our'', “us”)! The terms "we",
            "us" or "our" shall refer to Company. The terms "you", "your",
            "User" or "customer" shall refer to any individual or entity who
            browses/uses our Site, has access or uses the Services.
          </p>
          <p>
            These Terms of Service (“Terms”, “Terms of Service”) govern your use
            of our website located at thinkwht.com (together or individually
            “Service”) operated by ELVDRIVE SCOOTER LLP engaged in online live
            tutoring. Whether you are simply browsing or using this Site or
            purchasing Services, your use of this Site signifies that you have
            read, understood, acknowledged and agreed to be bound by all the
          ...
          <p>
            ...
            incorporated herein, at any time even without giving prior
            information, and such changes or modifications shall be effective
          ...
          <p>
            Thinkwht grants you a revocable, non-exclusive, non-transferable
            license to access, view and use the Platform only for the purposes
            of accessing, viewing, posting or submitting user material, using
            the embedded link function, placing store orders or for accessing
            information, applications and services.
          </p>
          <p>
            You are agreeing to be bound by these terms and conditions. If you
            don't agree to any of the terms and conditions, please don't use our
            services. "You" refers both to you as an individual and to the
            entity you represent. If you violate any of these terms, we reserve
            the right to cancel your account or block your access to our
            services and platforms.
          </p>
          <p>
            You are not permitted to reproduce, transmit, distribute,
            sub-license, broadcast, disseminate, or prepare derivative works of
            the Curriculum, or any part thereof, in any manner or through any
          ...
          <p>
            ...
            send. You hereby explicitly consent to receive email, telephone,
            WhatsApp or text messages from Thinkwht, for the purpose of
            providing alerts or information related to our services. However,
          ...
          <p>
            Our platform and it's entire contents, features and functionalities
            (including but not limited to all informations, software, texts,
            displays, images, video and audio and the design, selection and
            arrangement
          </p>
          <p>
            there of ), are owned by us, its licensors or other providers of
            such material and are protected by international copyright,
            trademark, patent, trade secret and other intellectual property or
            proprietary rights laws. You undertake that you shall not record,
            make videos or sound/ audio recordings, take screen shots, click
            pictures and shall not download, publish, transmit, display,
            reproduce, transmit, distribute, post, share or make copies of any
            of the classes/ lectures that are conducted by the Company
            (including the demo classes), video recordings, sound/audio
            recordings, images, photos, pictures/ images, text or other
            material, whether in full or in part, unless you obtain prior
            written approval from the Company, unless and except as is expressly
          ...
          <p>
            ...
            attorneys’ fees) for misrepresentation or malafide claims on the
          ...
          <p>You can contact us via email at thinkwht@gmail.com</p>
          ...
          <p>
            ...
            acknowledge and agree that your payment will be charged and
            processed by Thinkwht.
          </p>
          <p>
          ...
          <p>
            ...
            service, error in your order, fraud or an unauthorized or illegal
            transaction is suspected, or other reasons. Also the company
            expressly reserves the right to change or modify its prices and fees
            at any time, and such changes or modifications shall be posted
          ...
          <p>
            ...
            cancel it or Thinkwht cancels it. You may cancel your Subscription
            renewal either through your online account management page or by
            contacting thinkwht@gmail.com customer support team 6387889987.
          </p>
          <p>
            A valid payment method is required to process the payment for your
            subscription. You will provide Thinkwht with accurate and complete
            ...
            you automatically authorize Thinkwht to charge all Subscription fees
            incurred through your account to any such payment instruments.
          </p>
          <p>
            Should automatic billing fail to occur for any reason, Thinkwht
            reserves the right to terminate your access to the Service with
            immediate effect. You agree to immediately notify us of any change
            in your billing address or the credit card used for payment
            hereunder. Any attorney fees, court costs, or other costs incurred
            in collection of due amounts shall be the responsibility of and paid
            for by you. No contract will exist between you and us for the
            Service until we accept your order by a confirmatory e-mail, SMS/MMS
          ...
          <p>
            ...
            may request a refund under the terms and conditions of our Refund
            Policy which can be accessed.
          </p>
          <h1>6. RULES OF USER CONDUCT </h1>
          <p>By using this Site You acknowledge and agree that: </p>
          <p>
             Your use of this Site, including any content you submit, will
            comply with this Agreement and all applicable local, state, national
          ...
          <h1>7. RESPONSIBLE DISCLOSURE POLICY</h1>
          <p>
            At Thinkwht, we consider the security of our systems a top priority.
            But no matter how much effort we put into system security, there can
            still be vulnerabilities present. If you discover a vulnerability,
            we would like to know about it so we can take steps to address it as
            quickly as possible.
          </p>
          <p>
            We would like to ask you to help us better protect our clients and
            our systems. Please do the following:
          </p>
          <p> E-mail your findings to thinkwht@gmail.com</p>
          <p>
            ...
            demonstrate the vulnerability or deleting or modifying other
            people's data,
          </p>
          <p>
          ...
          <p>
            ...
            permission, We will keep you informed of the progress towards
          ...
          <p>
             As a token of our gratitude for your assistance, we may offer a
            reward for your report of a security problem that was not yet known
            to us. The amount of the reward will be determined based on the
            severity of the leak and the quality of the report. However, you are
            not bound to offer a reward for each report.
          </p>
          <p>
          ...
          <h1>8. DISCLAIMER OF REPRESENTATIONS AND WARRANTIES</h1>
          <p>
          ...
          <p>
            COMPANY, ITS OFFICERS, DIRECTORS, EMPLOYEES, AGENTS,OR ANY PERSON
            ASSOCIATED WITH US DISCLAIM ALL WARRANTIES, STATUTORY, EXPRESS OR
          ...
          <p>
            ...
            AGENTS, OTHER ASSOCIATED PERSONS, AND ALL THIRD PARTY SERVICE
            PROVIDERS, BE LIABLE TO YOU OR ANY OTHER PERSON OR ENTITY FOR ANY
            DIRECT, INDIRECT, INCIDENTAL, SPECIAL, PUNITIVE, OR CONSEQUENTIAL
            DAMAGES WHATSOEVER, INCLUDING ANY DAMAGES THAT MAY RESULT FROM (I)
            THE ACCURACY, COMPLETENESS, OR CONTENT OF THIS SITE, (II) THE
          ...
          <p>
            SERVICES FOUND AT THIS SITE OR ANY SITES LINKED (THROUGH HYPERLINKS,
            BANNER ADVERTISING OR OTHERWISE) TO THIS SITE, (IV) PERSONAL INJURY
            OR PROPERTY DAMAGE OF ANY NATURE WHATSOEVER, (V) THIRD-PARTY CONDUCT
            OF ANY NATURE WHATSOEVER, (VI) ANY INTERRUPTION OR CESSATION OF
            SERVICES TO OR FROM THIS SITE OR ANY SITES LINKED (THROUGH
            HYPERLINKS, BANNER ADVERTISING OR OTHERWISE) TO THIS SITE, (VII) ANY
            ...
            COMPANY IS ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. IN ADDITION,
            You SPECIFICALLY ACKNOWLEDGE AND agree that any cause of action
            arising out of or related to this Site or the Services found at this
            Site must be commenced within one (1) year after the cause of action
          ...
          <p>
            You are held personally liable for any violation of the terms and
            conditions or a third party's rights by you and your Child. You
            agree to reimburse the Company for all damages (including all court
            and legal fees) resulting from such activities or from the culpable
            non-observance of the obligations of these Terms.
          </p>
          <h1>10. TERMINATION</h1>
          <p>
            We may, in its sole discretion terminate or suspend your account and
          ...
          <p>
            Termination shall not affect any rights or remedies, which have
            accrued up to the time of termination.
          </p>
          <h2>11. ASSIGNMENT</h2>
          <p>
            Any rights and licenses granted hereunder shall not be transferred
            or assigned by you but shall be assigned by the Company. Any
          ...
          <p>
            ...
            and its officers, directors, employees, agents and any person
            associated with us, from and against any and all claims, demands,
          ...
          <p>
            These terms and conditions, together with the Privacy Policy and any
            ...
            court of competent jurisdiction, the invalid of such provision shall
            ...
            waiver of such term or any other term, and our failure to assert any
          ...
          <p>
            ...
            and no delay in exercising, on the part of either party, any right
            or any power under this Agreement shall operate as a waiver of that
            right or power. Nor shall any single or partial exercise of any
            right or power under this Agreement preclude further exercise of
          ...
          <h3>15. DISPUTE RESOLUTION AND GOVERNING LAWS </h3>
          <p>
            ...
            Maharashtra. The courts of Maharashtra shall have exclusive
          ...
          <p>
            ...
            us at thinkwht@gmail.com, call on +91-6387889987 or by post to:
